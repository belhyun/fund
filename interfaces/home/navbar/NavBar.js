    ...
    render() {
        return (
                <nav className="navbar navbar-light navbar-expand-md custom-header">
                    <div className="container-fluid"><a className="navbar-brand" href="#"><img className="img-fluid" src="assets/img/KD-White.png" width="auto" height="auto" style={{width: 43, margin: '-26px', marginRight: '-27px', marginTop: '-32px', marginLeft: '-33px', marginBottom: '-31px'}} /><span style={{marginLeft: 27, fontFamily: '"News Cycle", sans-serif', color: 'rgb(253,250,254)'}}>Key-Druide </span></a>
                        ...
                        <div className="collapse navbar-collapse" id="navbar-collapse">
                            ...
                            <ul className="nav navbar-nav ml-auto">
                                <li className="dropdown"><a className="dropdown-toggle nav-link" data-toggle="dropdown" aria-expanded="false" href="#"> <img src="assets/img/avatar.jpg" className="dropdown-image" /></a>
